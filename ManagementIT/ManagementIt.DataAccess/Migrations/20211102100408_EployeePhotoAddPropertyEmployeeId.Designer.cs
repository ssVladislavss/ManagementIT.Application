...
namespace ManagementIt.DataAccess.Migrations
{
    ...
    [Migration("20211102100408_EployeePhotoAddPropertyEmployeeId")]
    partial class EployeePhotoAddPropertyEmployeeId
    {
            ...
            modelBuilder.Entity("ManagementIt.Core.Domain.SharedTables.EmployeePhoto", b =>
                {
                    b.HasOne("ManagementIt.Core.Domain.SharedTables.Employee", null)
                        .WithOne("Photo")
                        .HasForeignKey("ManagementIt.Core.Domain.SharedTables.EmployeePhoto", "EmployeeId")

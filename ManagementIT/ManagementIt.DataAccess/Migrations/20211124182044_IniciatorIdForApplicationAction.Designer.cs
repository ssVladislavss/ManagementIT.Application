...
namespace ManagementIt.DataAccess.Migrations
{
    ...
    [Migration("20211124182044_IniciatorIdForApplicationAction")]
    partial class IniciatorIdForApplicationAction
    {
            ...
            modelBuilder.Entity("ManagementIt.Core.Domain.ApplicationEntity.ApplicationAction", b =>
                {
                    ...
                    b.Property<string>("FullNameIniciator")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("IniciatorId")
                        .HasColumnType("integer");

...
namespace ManagementIt.DataAccess.Migrations
{
    ...
    [Migration("20211026205803_firstdata4")]
    partial class firstdata4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManagementIt.Core.Domain.SharedTables.Room", b =>
                {
                    b.HasOne("ManagementIt.Core.Domain.SharedTables.Building", null)
                        .WithMany("Rooms")
                        .HasForeignKey("BuildingId");

                    b.HasOne("ManagementIt.Core.Domain.SharedTables.Departament", null)
                        .WithMany("Rooms")
                        .HasForeignKey("DepartamentId");
                });
